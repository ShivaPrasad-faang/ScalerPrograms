...
public class RepeatMissingNumberArray {
    public static void main(String[] args){
        ...
        for(int i=0;i<tmp.length;i++){
           // tmp[Inp[i]]
            ...
            System.out.println(Inp[i]+" "+tmp[Inp[i]]+" ");
           // tmp[Inp[i]]=tmp[Inp[i]]+1;
        }
    }
    ...
    public static int[] bubbleSort(int[] Inp)
    {
        int n = Inp.length;
        for (int i = 0; i < n - 1; i++)
    ...
    public static int[] temp(int[] Inp)
    {
        int[] n = new int[Inp.length+1];
